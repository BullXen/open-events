...
<div class="em-form-container em-hub-view">
    <div class="em-hub-header">
        ...
        <a href="<?php echo esc_url( add_query_arg( [ 'view' => 'tribe_events', 'action' => 'add', 'type' => 'tribe_events' ] ) ); ?>" class="em-submit-btn link-btn">
            + <?php printf( esc_html__( 'Nuovo %s', 'open-events' ), esc_html__( 'Evento', 'open-events' ) ); ?>
        </a>
    </div>

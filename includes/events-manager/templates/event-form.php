            ...
            <form method="POST" enctype="multipart/form-data" class="em-modern-form">
                ...
                <?php if ( 'tribe_events' === $post_type ): 
                    ...
                    <div class="em-form-section">
                        ...
                        <?php $show_all_day_field = open_events_is_all_day_event_enabled();
                        $show_recurring_field = open_events_is_recurring_event_enabled(); ?>
                        <?php if ( $show_all_day_field || $show_recurring_field ) : ?>
                        <div class="em-form-row-grid">
                            <?php if ( $show_all_day_field ) : ?>
                        ...
                        <div class="em-form-row-grid em-row-flush">
                        ...
                        <div class="em-form-row-grid-vertical">
                            ...
                            <div class="em-form-group">
                                ...
                                <select name="event_organizer" class="em-form-select em-organizer-select">
                                    ...
                                    // Prima gli organizzatori inseriti dall'utente stesso, poi tutti gli altri.
                                    $own_organizers   = [];
                                    $other_organizers = [];
                                    foreach ( $organizers as $org ) {
                                        if ( (int) $org->post_author === (int) $current_user_id ) {
                                            $own_organizers[] = $org;
                                        } else {
                                            $other_organizers[] = $org;
                                        }
                                    }
                                    ?>
                                    <?php if ( $own_organizers ) : ?>
                                        <optgroup label="<?php esc_attr_e( 'I tuoi organizzatori', 'open-events' ); ?>">
                                            <?php foreach ( $own_organizers as $org ) : ?>
                                                <option value="<?php echo esc_attr( $org->ID ); ?>" <?php selected( $current_org, $org->ID ); ?>><?php echo esc_html( $org->post_title ); ?></option>
                                            <?php endforeach; ?>
                                        </optgroup>
                                    <?php endif; ?>
                                    <?php if ( $other_organizers ) : ?>
                                        <optgroup label="<?php esc_attr_e( 'Altri organizzatori', 'open-events' ); ?>">
                                            <?php foreach ( $other_organizers as $org ) : ?>
                                                <option value="<?php echo esc_attr( $org->ID ); ?>" <?php selected( $current_org, $org->ID ); ?>><?php echo esc_html( $org->post_title ); ?></option>
                                            <?php endforeach; ?>
                                        </optgroup>
                                    <?php endif; ?>
                ...
                <div class="em-form-actions">
                    <a href="<?php echo esc_url( $form_list_url ); ?>" class="em-cancel-btn" aria-label="<?php esc_attr_e( 'Annulla', 'open-events' ); ?>">
                        <span class="em-cancel-icon"><?php $this->render_icon( 'close' ); ?></span>
                        <span class="em-cancel-label"><?php esc_html_e( 'Annulla', 'open-events' ); ?></span>
                    </a>
